...
function Credits:fill()
	...
	self:addVerticalSpaceS()
	self:addLineM("\"Dancing on Clouds\"")
	self:addVerticalSpaceS()
	self:addLineM("\"Pond at Twilight\"")
	self:addVerticalSpaceS()
	self:addLineM("\"Still of Night\"")
	self:addVerticalSpaceS()
	self:addLineM("\"Fog Lands\"")
	self:addVerticalSpaceS()
	self:addLineM("\"Unforgiving Himalayas\"") 
	self:addVerticalSpaceS()
	self:addLineM("\"They're Closing In\"") 
	self:addVerticalSpaceS()
	self:addLineM("\"Mountainside\"") 
	self:addVerticalSpaceS()
	self:addLineS("by Eric Matyas")
	self:addLineS("www.soundimage.org")
	self:addVerticalSpaceM()
	
	self:addLineM("\"3 Open Surge score jingle - C\"")
	self:addVerticalSpaceS()
